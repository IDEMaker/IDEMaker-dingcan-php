<?php
/* Smarty version 3.1.30, created on 2017-12-02 19:19:59
  from "/home/wwwroot/www.dingfan.fmlynet.cn/views/adminmer/goodsc/goods_list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a228c5f32efa9_65684550',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1cfcc76ac8fc228c9047bd82854c1ad4672786af' => 
    array (
      0 => '/home/wwwroot/www.dingfan.fmlynet.cn/views/adminmer/goodsc/goods_list.html',
      1 => 1511408898,
      2 => 'file',
    ),
  ),
...
function content_5a228c5f32efa9_65684550 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
>
    <?php echo '<script'; ?>
>pageurl="?m=adminmer&c=Goodsc&a=goods_list";<?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo JS;?>
    ...
    <div class="details_operation clearfix">
        ...
        <div class="details_operation clearfix">
            ...
            <div class="fr">
                ...
                <span>
                                <input type="text" value="" placeholder="搜索如:商品编号/余额" class="search form-control" name="search">
                                </span>
                    <span>
...
<?php echo '<script'; ?>
 type="text/javascript">
    ...
    function addPro(){
        window.location='?m=adminmer&c=Goodsc&a=index';
    }
    function editPro(id,pSn){
        window.location='?m=adminmer&c=Goodsc&a=goods_edit&id='+id+'&pSn='+pSn;
    }
    function delPro(id){
        if(window.confirm("您确认要删除嘛？添加一次不易，且删且珍惜!")){
            window.location="?m=adminmer&c=Goodsc&a=goods_delete&id="+id;
        }
    }
    function search(){
        if(event.keyCode==13){
