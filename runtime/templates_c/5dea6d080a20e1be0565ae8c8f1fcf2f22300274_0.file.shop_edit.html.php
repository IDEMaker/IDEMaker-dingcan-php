<?php
/* Smarty version 3.1.30, created on 2017-12-05 07:36:53
  from "/home/wwwroot/www.dingfan.fmlynet.cn/views/admin/shopc/shop_edit.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a25dc15697302_32592026',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5dea6d080a20e1be0565ae8c8f1fcf2f22300274' => 
    array (
      0 => '/home/wwwroot/www.dingfan.fmlynet.cn/views/admin/shopc/shop_edit.html',
      1 => 1511415430,
      2 => 'file',
    ),
  ),
...
function content_5a25dc15697302_32592026 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
"/></td>
   ...
   不改则和当前城市填写一致"></td>
            ...
            <tr>
                <td align="right"><span class="td-txt">店铺余额</span></td>
                <td><input type="text" name="shopTip" placeholder="店铺余额" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['balance'];?>
" disabled/></td>
            </tr>
            <tr>
...
"/></td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-td">
                        <?php if ($_smarty_tpl->tpl_vars['data']->value['isAudit'] == 1) {?>
                        <input type="radio" name="isAudit" checked value="1" ><span class="td-txt">审核</span>
                        <?php } else { ?>
                        <input type="radio" name="isAudit"  value="1" ><span class="td-txt">审核</span>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['data']->value['isAudit'] == 0) {?>
                        <input type="radio" name="isAudit"  checked value="0" ><span class="td-txt">未审核</span>
                        <?php } else { ?>
