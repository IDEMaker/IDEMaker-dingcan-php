<?php
/* Smarty version 3.1.30, created on 2017-12-03 18:40:01
  from "/home/wwwroot/www.dingfan.fmlynet.cn/views/admin/orderc/order_moniter.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a23d4810bf845_40597929',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '976b32f5c311986ae43c760dc0f6b3b476fa3a35' => 
    array (
      0 => '/home/wwwroot/www.dingfan.fmlynet.cn/views/admin/orderc/order_moniter.html',
      1 => 1511419628,
      2 => 'file',
    ),
  ),
...
function content_5a23d4810bf845_40597929 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
>
    <?php echo '<script'; ?>
>pageurl="?m=admin&c=Orderc&a=order_moniter";<?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo JS;?>
...
//    }
    ...
    function takeOrder(id){
        ...
        var postUrl="?m=admin&c=Orderc&a=order_moniter";
        $.post(postUrl,
            {type:"take", id:id},
...
//                        $(".order-delivery").jqprint();
                        showAlert("提示","接单成功","?m=admin&c=Orderc&a=order_moniter");
                    } else{
                        showAlert("提示",$res.msg,"?m=admin&c=Orderc&a=order_moniter");
                    }
                }else{
                    showAlert("提示","服务器异常");
                }
        ...
        $.post(postUrl,
            ...
            function(data,status,xhr) {
                if(status=="success"){
                    $res= $.parseJSON(data);
                    if($res.code=="0"){
                        showAlert("提示","已拒绝","?m=admin&c=Orderc&a=order_moniter");
                    } else{
                        showAlert("提示",$res.msg,"?m=admin&c=Orderc&a=order_moniter");
                    }
                }else{
