<?php
/* Smarty version 3.1.30, created on 2017-12-02 19:19:36
  from "/home/wwwroot/www.dingfan.fmlynet.cn/views/adminmer/orderc/order_moniter.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a228c48149238_67332664',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1dc7f2191300f0d54f5a032687166550cc0decc7' => 
    array (
      0 => '/home/wwwroot/www.dingfan.fmlynet.cn/views/adminmer/orderc/order_moniter.html',
      1 => 1511360892,
      2 => 'file',
    ),
  ),
...
function content_5a228c48149238_67332664 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
>
    <?php echo '<script'; ?>
>pageurl="?m=adminmer&c=Orderc&a=order_moniter";<?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo JS;?>
...
?>
                    ...
                    <div class="order-operator " >
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['val']->value['pay'] == 1 && $_smarty_tpl->tpl_vars['val']->value['received'] == 0 || $_smarty_tpl->tpl_vars['val']->value['paymethod'] == 2 && $_smarty_tpl->tpl_vars['val']->value['received'] == 0) {?>
                            <a class=pay-btn onclick=takeOrder(<?php echo $_smarty_tpl->tpl_vars['val']->value['orderId'];?>
)>接单</a><a class=pay-btn onclick=cancelOrder(<?php echo $_smarty_tpl->tpl_vars['val']->value['orderId'];?>
)>拒绝</a>
                        <?php }?>
                        </div>
                    </div>
...
//    }
    ...
    function takeOrder(id){
        ...
        var postUrl="?m=adminmer&c=Orderc&a=order_moniter";
        $.post(postUrl,
            {type:"take", id:id},
...
//                        $(".order-delivery").jqprint();
                        showAlert("提示","接单成功","?m=adminmer&c=Orderc&a=order_moniter");
                    } else{
                        showAlert("提示",$res.msg,"?m=adminmer&c=Orderc&a=order_moniter");
                    }
                }else{
                    showAlert("提示","服务器异常");
                }
        ...
        $.post(postUrl,
            ...
            function(data,status,xhr) {
                if(status=="success"){
                    $res= $.parseJSON(data);
                    if($res.code=="0"){
                        showAlert("提示","已拒绝","?m=adminmer&c=Orderc&a=order_moniter");
                    } else{
                        showAlert("提示",$res.msg,"?m=adminmer&c=Orderc&a=order_moniter");
                    }
                }else{
